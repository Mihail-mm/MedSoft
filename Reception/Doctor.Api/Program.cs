...
using Doctor.Presentation.Http.Extensions;
...
{
    options.ListenAnyIP(7174, listenOptions => { listenOptions.UseHttps(certPath, certPassword); });
});
...
builder.Services.AddDoctorApplication();
...
builder.Services.AddCors(options =>
{
    ...
    {
        policy.WithOrigins("https://localhost:7174", "http://localhost:5165")
            .AllowAnyMethod()
            .AllowAnyHeader();
    });
});
